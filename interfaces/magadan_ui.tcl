...
## Flush - 4
create_settings_button "magadan_off" $l_btn_left [expr {$l_btn_top + 4 * ($l_btn_height + $l_btn_spacer)}] [expr {$l_btn_left + $l_btn_width}] [expr {$l_btn_top + 4 * ($l_btn_height + $l_btn_spacer) + $l_btn_height}] $::font_tiny [::theme button_secondary] [::theme button_text_light]  {set ::iconik_settings(flush_timeout) [expr {$::iconik_settings(flush_timeout) - 0.5}]; iconik_save_settings} {  set ::iconik_settings(flush_timeout) [expr {$::iconik_settings(flush_timeout) + 0.5}]; iconik_save_settings} {Flush:\n[round_to_one_digits $::iconik_settings(flush_timeout)]s}
...
create_button "magadan_off" 260 [expr {$l_btn_top + 0 * ($l_btn_height + $l_btn_spacer)}] [expr {$l_btn_left + $l_btn_width}] [expr {$l_btn_top + 0 * ($l_btn_height + $l_btn_spacer) + $l_btn_height}] $::font_big_icon [::theme button_secondary] [::theme button_text_light] {set ::settings(final_desired_shot_weight) $::iconik_settings(large_mug_setting);set ::settings(final_desired_shot_weight) $::iconik_settings(large_mug_setting);set ::settings(final_desired_shot_weight_advanced) $::iconik_settings(large_mug_setting); profile_has_changed_set; save_profile; save_settings_to_de1; save_settings} {\uf7b6}
